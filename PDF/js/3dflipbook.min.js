!function (modules) {
    ...
    var _$ = window.jQuery, _html2canvas = window.html2canvas, _THREE = window.THREE, _React = window.React,
        _ReactDOM = window.ReactDOM, _PDFJS = window.pdfjsLib, _tr = function (s) {
        ...
        return BaseMathUtils.sum1 = function (ka, a, kb, b) {
            ...
            for (; !done;) {
                ...
                for (var np = {x: p.x + Math.random() - .5, y: p.y + Math.random() - .5}, rn = {
                    ...
                    var p0 = ps[_i5], p1 = ps[(_i5 + 1) % ps.length], n = {x: p1.x - p0.x, y: p1.y - p0.y},
    ...
    exports.__esModule = !0;
    var _GraphUtils = __webpack_require__(4), _GraphUtils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    var _Cache = __webpack_require__(14), _Cache2 = _interopRequireDefault(_Cache),
        _BlankImage = __webpack_require__(46), _BlankImage2 = _interopRequireDefault(_BlankImage),
        _StaticImage = __webpack_require__(62), _StaticImage2 = _interopRequireDefault(_StaticImage),
        _PdfImage = __webpack_require__(60), _PdfImage2 = _interopRequireDefault(_PdfImage),
        _InteractiveImage = __webpack_require__(54), _InteractiveImage2 = _interopRequireDefault(_InteractiveImage),
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
            ...
            return target
        }, _libs = __webpack_require__(1), _sheetBlock = __webpack_require__(44),
        _sheetBlock2 = _interopRequireDefault(_sheetBlock), _MathUtils = __webpack_require__(5),
        _MathUtils2 = _interopRequireDefault(_MathUtils), _ThreeUtils = __webpack_require__(21),
        _ThreeUtils2 = _interopRequireDefault(_ThreeUtils), SheetBlock = function () {
            ...
            return SheetBlock.prototype.dispose = function () {
                ...
                var state = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.state,
                    ...
                    flipDirection = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : "right", PI = Math.PI;
                this.state = state;
                ...
                var bl = void 0, r = [], p1 = _extends({}, this.pSpline.getPoint(.999)),
                    p2 = _extends({}, this.pSpline.getPoint(1)), dp = {x: p2.x - p1.x, y: p2.y - p1.y},
                    ln = Math.sqrt(dp.x * dp.x + dp.y * dp.y), sp = this.pSpline.points[this.pSpline.points.length - 1];
                ...
                return {
                    ...
                    openedInterpolationIndeces: [{left: [2, 3, 4], right: [2, 3, 4]}, {
                        left: [2, 6, 5],
                        right: [2, 3, 4]
    ...
    function props() {
        ...
        return {
            volume: def,
            flat: _extends({}, def, {
                sheet: _extends({}, def.sheet, {wave: .05, side: "transparent", shape: 1}),
    ...
    exports.__esModule = !0;
    var _EventConverter2 = __webpack_require__(7), _EventConverter3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _Utils = __webpack_require__(3), _Utils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _FullScreen2 = __webpack_require__(53), _FullScreen3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _Utils = __webpack_require__(3), _Utils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    }(_Utils);
    _libs.PDFJS.GlobalWorkerOptions.workerSrc = (window.PDFJS_LOCALE ? PDFJS_LOCALE : __webpack_require__.i({
        pdfJsWorker: "https://ebharbook.com/public/front/readBook/js/pdf.worker.js",
        pdfJsCMapUrl: "cmaps/"
    ...
    var Pdf = function () {
        ...
        return Pdf.prototype.init = function (handler, pages) {
            ...
            var x = page.view[2] - page.view[0], y = page.view[3] - page.view[1], a = page.rotate * Math.PI / 180;
            return {
    ...
    var _Controller2 = __webpack_require__(15), _Controller3 = function (obj) {
        ...
        return _inherits(WidgetController, _Controller), WidgetController.prototype.togle = function () {
            ...
            this.view && this.view.setState(this.name, {enable: !0, visible: this.visible, active: !1})
        }, WidgetController
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(1), _Detector = __webpack_require__(48),
        _Detector2 = _interopRequireDefault(_Detector), _VisualWorld = __webpack_require__(70),
        _VisualWorld2 = _interopRequireDefault(_VisualWorld), _PdfLinksHandler = __webpack_require__(37),
        _PdfLinksHandler2 = _interopRequireDefault(_PdfLinksHandler), _Book = __webpack_require__(28),
        _Book2 = _interopRequireDefault(_Book), _BookView = __webpack_require__(31),
        _BookView2 = _interopRequireDefault(_BookView), _BookController = __webpack_require__(29),
        _BookController2 = _interopRequireDefault(_BookController), _PdfBookPropsBuilder = __webpack_require__(36),
        ...
        _LoadingController = __webpack_require__(56), _LoadingController2 = _interopRequireDefault(_LoadingController),
        _UserMessageController = __webpack_require__(68),
        _UserMessageController2 = _interopRequireDefault(_UserMessageController), _Search = __webpack_require__(61),
        _Search2 = _interopRequireDefault(_Search), _Bookmarks = __webpack_require__(47),
        _Bookmarks2 = _interopRequireDefault(_Bookmarks), _Thumbnails = __webpack_require__(66),
        _Thumbnails2 = _interopRequireDefault(_Thumbnails), _TocController = __webpack_require__(43),
        _TocController2 = _interopRequireDefault(_TocController), _ShareController = __webpack_require__(39),
        _ShareController2 = _interopRequireDefault(_ShareController), _BookPrinter = __webpack_require__(30),
        _BookPrinter2 = _interopRequireDefault(_BookPrinter), _AutoNavigator = __webpack_require__(26),
        _AutoNavigator2 = _interopRequireDefault(_AutoNavigator), _SoundsEnviroment = __webpack_require__(42),
        _SoundsEnviroment2 = _interopRequireDefault(_SoundsEnviroment), _FullScreenX = __webpack_require__(18),
    ...
    _libs.$.fn.FlipBook = function (options) {
        ...
        return options.activateFullScreen && _FullScreenX2.default.request(parentContainer), scene.view = new _BookView2.default(parentContainer, function () {
            ...
            } else _Detector2.default.addGetWebGLMessage({parent: scene.view.getView()})
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _libs = __webpack_require__(1), _MathUtils = __webpack_require__(5), _MathUtils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
        ...
        function Binder(visual, p) {
            ...
            var color = "color" === this.p.cover.side ? {color: p.cover.color} : {
                color: p.cover.color,
                opacity: 0,
                transparent: !0
            };
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(1), _book = __webpack_require__(11), _GraphUtils = __webpack_require__(4),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), _Binder = __webpack_require__(27),
        _Binder2 = _interopRequireDefault(_Binder), _Cover = __webpack_require__(33),
        _Cover2 = _interopRequireDefault(_Cover), _SheetBlock = __webpack_require__(10),
        _SheetBlock2 = _interopRequireDefault(_SheetBlock), _SheetPhysics = __webpack_require__(41),
        _SheetPhysics2 = _interopRequireDefault(_SheetPhysics), _PageManager = __webpack_require__(35),
        _PageManager2 = _interopRequireDefault(_PageManager), _CSSLayer = __webpack_require__(13),
        _CSSLayer2 = _interopRequireDefault(_CSSLayer), _CssLayersManager = __webpack_require__(34),
        _CssLayersManager2 = _interopRequireDefault(_CssLayersManager), _SearchEngine = __webpack_require__(38),
        _SearchEngine2 = _interopRequireDefault(_SearchEngine), _CustomEventConverter = __webpack_require__(16),
        _CustomEventConverter2 = _interopRequireDefault(_CustomEventConverter), _CircleTarget = __webpack_require__(72),
        _CircleTarget2 = _interopRequireDefault(_CircleTarget), _YouTubeApi = __webpack_require__(71),
        _YouTubeApi2 = _interopRequireDefault(_YouTubeApi), Book = function (_THREE$EventDispatche) {
            ...
            return _inherits(Book, _THREE$EventDispatche), Book.prototype.dispose = function () {
                ...
                if (this.mouseController) {
                    ...
                    if ("mouseover" === e.type) {
                        if (this.hoverInfo && void 0 !== this.hoverInfo.pendings) ++this.hoverInfo.pendings; else if (this.hoverInfo && (console.warn("Wrong state: element is already hover"), this.hoverInfo.n !== n && this.clearHoverInfo()), !this.hoverInfo && !this.dragInfo) {
                            var res = Promise.resolve(void 0), hover = this.getBlockByPage(n),
                ...
                return (this.sheetPhysics.getSize() ? Promise.resolve() : this.notifyBeforeAnimation()).then(function () {
                    return block.physicId = _this6.sheetPhysics.addObject(mass, angle, velocity, flexibility, coverHeight, function (angl, ch) {
                        ...
                        if (removeClb(angl, ch), delete block.physicId, progressClb(block, Math.abs(angle - angl) / Math.PI, "finish", type()), !_this6.sheetPhysics.getSize()) {
                            var p = _this6.getPage();
                            0 !== p && p !== _this6.getPages() - 1 || _this6.reducePagesWidth(!0)
                        }
                        Promise.resolve().then(function () {
                    ...
                    }), progressClb(block, 0, "init", type()), 1 === _this6.sheetPhysics.getSize() && _this6.reducePagesWidth(!1), block
                }).catch(function () {
                })
                ...
                var p = _extends({}, props, {
                    ...
                    }), height = 10 * p.height, width = 10 * p.width, flexibleCornerK = Math.min(height, width) / width,
                ...
                return function (n, clb) {
                    return loader(n, function (ls) {
                        for (var nls = [], _iterator7 = ls, _isArray7 = Array.isArray(_iterator7), _i7 = 0, _iterator7 = _isArray7 ? _iterator7 : _iterator7[Symbol.iterator](); ;) {
                            var _ref7;
                            if (_isArray7) {
                ...
                return function (c, p) {
                    ...
                    }, _i8 = 0; _i8 < _arr.length; _i8++) _loop();
                    return ro
                }
    ...
    var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) {
        ...
        _Controller3 = _interopRequireDefault(_Controller2), _bookController = __webpack_require__(45),
        _EventsToActions = __webpack_require__(52), _EventsToActions2 = _interopRequireDefault(_EventsToActions),
        _stats = __webpack_require__(74), _stats2 = _interopRequireDefault(_stats),
        _Object3DWatcher = __webpack_require__(58), _Object3DWatcher2 = _interopRequireDefault(_Object3DWatcher),
        ...
        BookController = function (_Controller) {
            function BookController(book, view, props) {
                ...
                var box0 = new _libs.THREE.Box3, box1 = new _libs.THREE.Box3,
                ...
                return _this.bookWatcher = new _Object3DWatcher2.default(_this.visual, function () {
                    if (_this.state.singlePage) _this.state.activeSide ? box0.setFromObject(book.rightCover.three) : box0.setFromObject(book.leftCover.three); else {
                        box0.setFromObject(book.leftCover.three), box1.setFromObject(book.rightCover.three), box0.union(box1);
                        var width = Math.max(box0.min.x - box0.min.x, bookWidth), x0 = (box0.min.x + box0.max.x) / 2;
            ...
            return _inherits(BookController, _Controller), BookController.prototype.dispose = function () {
                ...
                var _this3 = this, handler = function () {
                    for (var pages = _this3.book.getTopPages(), visible = !1, _iterator = pages, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator](); ;) {
                        ...
                        var n = _ref, state = _this3.book.getPageState(n);
                ...
                var setClb = function (fl, time, clb) {
                    return new Promise(function (resolve) {
                        setTimeout(function () {
                            fl < 0 ? _this6.startFlip(_this6.book.flipLeft(-fl, clb)) : _this6.startFlip(_this6.book.flipRight(fl, clb)), resolve()
                        }, time)
                    })
                };
                ...
                return _extends({}, cmds, {
                    ...
                    mouseCmdWheelZoom: {
                        activate: function (e) {
                            ...
                            e.deltaY < 0 ? _this8.cmdZoomOut() : e.deltaY > 0 && _this8.cmdZoomIn(), (!_this8.state.smartPan || Math.abs(_this8.bookWatcher.scale - scale) > 1e-4) && e.preventDefault()
                        }
                    },
                    touchCmdRotate: {
                        activate: function (e, data) {
                            isSwipping("touchCmdRotate") || ("move" === data.state && e.preventDefault(), _this8.orbit.actions.rotate(e, data))
                        }
                    },
                    touchCmdZoom: {
                        activate: function (e, data) {
                            if (!isSwipping("touchCmdZoom")) {
                                ...
                                } : "move" === data.state && (e.preventDefault(), _this8.setScale(l(data) / _this8.touchZoomData.l * _this8.touchZoomData.scale))
                            }
                        }
                    },
                    touchCmdPan: {
                        activate: function (e, data) {
                            isSwipping("touchCmdPan") || "move" === data.state && (!_this8.state.smartPan || _this8.bookWatcher.scale > 1) && (e.preventDefault(), _this8.orbit.actions.pan(e, data))
                        }
                    },
                    touchCmdSwipe: {
                        activate: function (e, data) {
    ...
    exports.__esModule = !0;
    var _View2 = (__webpack_require__(1), __webpack_require__(69)), _View3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _SheetCssLayer = __webpack_require__(40), _SheetCssLayer2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
        ...
        return CssLayersManager.prototype.getActives = function () {
            var page = this.book.getPage(), pages = this.book.getBookPages(),
                                ...
                                var finish = function () {
                                    if (layers.length && _this.wrappers) {
                                        for (var _block = _this.book.getBlockByPage(n), _iterator3 = layers, _isArray3 = Array.isArray(_iterator3), _i3 = 0, _iterator3 = _isArray3 ? _iterator3 : _iterator3[Symbol.iterator](); ;) {
                                            ...
                                            var l = _ref3,
                                                sl = new _SheetCssLayer2.default(_this.visual, _block, _extends({}, _this.props, {pageNumber: n}));
    ...
    var _extends = Object.assign || function (target) {
        ...
        _LoadingAnimation = __webpack_require__(55), _LoadingAnimation2 = _interopRequireDefault(_LoadingAnimation),
        _ImageFactory = __webpack_require__(8), _ImageFactory2 = _interopRequireDefault(_ImageFactory),
        _TextureAnimator = __webpack_require__(63), _TextureAnimator2 = _interopRequireDefault(_TextureAnimator),
        _GraphUtils = __webpack_require__(4), _GraphUtils2 = _interopRequireDefault(_GraphUtils),
        PageManager = function () {
            ...
            return PageManager.prototype.createLoadingTexture = function (p) {
                ...
                var _this3 = this,
                    pi = this.rtlPageN(n) < this.book.getPages() ? this.p.pageCallback(this.rtlPageN(n)) : {type: "blank"},
    ...
    exports.__esModule = !0;
    var _BookPropsBuilder2 = __webpack_require__(9), _BookPropsBuilder3 = _interopRequireDefault(_BookPropsBuilder2),
        _Pdf = __webpack_require__(19), _Pdf2 = _interopRequireDefault(_Pdf),
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(1), _WidgetController2 = __webpack_require__(22),
        _WidgetController3 = function (obj) {
            return obj && obj.__esModule ? obj : {default: obj}
        }(_WidgetController2), ShareController = function (_WidgetController) {
            ...
            return _inherits(ShareController, _WidgetController), ShareController.prototype.cmdCloseShare = function () {
                ...
                if (this.view) {
                    for (var _arr = ["cmdCloseShare", "cmdFacebook", "cmdTwitter", "cmdEmail"], _i = 0; _i < _arr.length; _i++) {
                        var cmd = _arr[_i];
                        this.view.setState(cmd, {enable: !0, visible: !0, active: !1})
                    }
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _MathUtils = __webpack_require__(5), _MathUtils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
        ...
        return SheetPhysics.targetForceClb = function (o, a, v, ch) {
            ...
            var v = y[0], l = y[1], ch = y[2], alf = l / this.r, f = this.f(this, alf, v, ch),
                cf = this.cf(this, alf, v, ch), cosAlf = Math.cos(alf),
    ...
    exports.__esModule = !0;
    var _WidgetController2 = __webpack_require__(22), _WidgetController3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    function props() {
        return {
            ...
            actions: {
                ...
                cmdSinglePage: {enabled: !0, enabledInNarrow: !0, active: !1, activeForMobile: !0},
    ...
    exports.__esModule = !0;
    var _ImageBase2 = (__webpack_require__(0), __webpack_require__(6)), _ImageBase3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(6),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _BaseMathUtils = __webpack_require__(2),
        _BaseMathUtils2 = _interopRequireDefault(_BaseMathUtils), _Dom2Image = __webpack_require__(50),
        _Dom2Image2 = _interopRequireDefault(_Dom2Image), _DocMouseSimulator = __webpack_require__(49),
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _GraphUtils = __webpack_require__(4),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), _MathUtils = __webpack_require__(5),
        _MathUtils2 = _interopRequireDefault(_MathUtils), LoadingAnimation = function () {
            ...
            return LoadingAnimation.prototype.dy = function (t, y) {
                ...
                if (this.os = this.integrate(T), this.t += T, this.t >= this.p.updateInterval) {
                    this.t = 0;
                    var r = .04 * Math.min(this.c.width, this.c.height), a = this.os[1], x0 = .5 * this.c.width,
                ...
                var c = _GraphUtils2.default.createCanvas(this.c.width * n, this.c.height), ctx = c.getContext("2d"),
                    t = this.calcTimeTo(this.os[1] + 2 * Math.sign(this.os[0]) * Math.PI), dt = t / (n + 1),
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _EventConverter2 = __webpack_require__(7), _EventConverter3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    var _extends = Object.assign || function (target) {
        ...
        return target
    }, _libs = __webpack_require__(0), _MathUtils = __webpack_require__(5), _MathUtils2 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
        ...
        function Object3DWatcher(visual, boundBoxClb) {
            ...
            _classCallCheck(this, Object3DWatcher), this.visual = visual, this.boundBoxClb = boundBoxClb, this.testScale = testScale, this.camera = visual.camera, this.element = this.visual.element, this.elementSize = {
                w: 1,
                h: 1
            }, this.devicePixelRatio = this.visual.wnd.devicePixelRatio || 1, this.orbit = visual.getOrbit(), this.scale = 1, this.padding = 0, this.eps = 1e-4, this.v = new _libs.THREE.Vector3, this.dv = new _libs.THREE.Vector2, this.enabled = !1, visual.addRenderCallback(this.update.bind(this)), this.os = {
                vx: 0,
                vy: 0,
                x: 0,
                y: 0
        ...
        return Object3DWatcher.prototype.setPadding = function (padding) {
            ...
            var dv = this.dv;
            if (K > 1 - this.eps) if (this.padding) {
                var height = this.visual.height(), marg = .5 * (Ky - 1) / Ky, pad = this.padding / height,
                    dpad = Math.max(0, Math.abs(pad) - marg);
                dv.set(-box.mid.x, -Math.sign(pad) * Math.min(Math.max(0, marg - 20 / height), dpad) - box.mid.y)
            } else dv.set(-box.mid.x, -box.mid.y); else dv.set(this.computeCorr(Kx, box.min.x, box.max.x), this.computeCorr(Ky, box.min.y, box.max.y));
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(6),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _Pdf = __webpack_require__(19),
        ...
        _CustomEventConverter2 = _interopRequireDefault(_CustomEventConverter), _PolyTarget = __webpack_require__(73),
        ...
        _Finder2 = _interopRequireDefault(_Finder), PdfImage = function (_ImageBase) {
            ...
            return _inherits(PdfImage, _ImageBase), PdfImage.prototype.setQuery = function (query) {
                ...
                if (this.page) {
                    this.pushCtx();
                    this.ctx.clearRect(0, 0, this.c.width, this.c.height), this.page.render({
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _ImageBase2 = __webpack_require__(6),
        _ImageBase3 = _interopRequireDefault(_ImageBase2), _Utils = __webpack_require__(3),
    ...
    exports.__esModule = !0;
    var _libs = __webpack_require__(0), _Utils = __webpack_require__(3), _Utils2 = _interopRequireDefault(_Utils),
    ...
    var _extends = Object.assign || function (target) {
        ...
        _ImageFactory2 = _interopRequireDefault(_ImageFactory), _GraphUtils = __webpack_require__(4),
        _GraphUtils2 = _interopRequireDefault(_GraphUtils), Thumbnails = function () {
            ...
            return Thumbnails.prototype.getSize = function () {
                ...
                if (!this.loading && this.canvas) {
                    ...
                    if (!this.loading) for (var i = this.queue.first; i < this.queue.first + this.queue.len; ++i) {
                ...
                for (var elements = ['<div class="thumbnails">'], i = 0; i < this.size; ++i) elements.push(['<div class="item"><a href="#"><div class="thumbnail loading" style="padding-top:' + Math.round(100 / this.p.kWtoH) + '%;"></div></a><div class="heading"><a href="#" title="', i + 1, '">', i + 1, "</a></div></div>"].join(""));
    ...
    var UserMessageController = (__webpack_require__(0), function () {
        ...
        return UserMessageController.prototype.dispose = function () {
            ...
            this.view && (this.view.setState("widUserMessage", {
                ...
                active: !1
            }), this.view.setState("txtUserMessage", {value: this.message, visible: !0}))
    ...
    var _extends = Object.assign || function (target) {
        ...
        function View(parentContainer, onLoad) {
            ...
            _classCallCheck(this, View), this.pendings = {}, this.binds = {onResize: this.onResize.bind(this)}, this.parentContainer = (0, _libs.$)(parentContainer), this.isIOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream, this.isSafari = /^((?!chrome|android).)*safari/i.test(navigator.userAgent);
            var initUrl = this.isSafari ? ("function" == typeof template ? template() : template).init : void 0;
            this.parentContainer.html('<iframe style="border: 0;' + (this.isIOS ? "" : " width: 100%; height: 100%") + '" ' + (initUrl ? ' src="' + initUrl + '"' : "") + ' scrolling="no"></iframe>'), this.frame = this.parentContainer.find("iframe")[0];
            var build = function build() {
                ...
                var script = template.html ? template.script : _this3.getTemplate().script, urls = void 0,
                    files = void 0, links = void 0, templateName = void 0;
    ...
    var _extends = Object.assign || function (target) {
            ...
            return target
        }, _libs = __webpack_require__(0), _Utils = __webpack_require__(3), _Utils2 = _interopRequireDefault(_Utils),
        _Orbit = __webpack_require__(59), _Orbit2 = _interopRequireDefault(_Orbit),
        ...
        _ThreeTouchEventConverter2 = _interopRequireDefault(_ThreeTouchEventConverter), _Drag = __webpack_require__(51),
        ...
        return YouTubeApi.init = function () {
            return YouTubeApi.task || (YouTubeApi.task = new Promise(function (resolve) {
                window.YT || (window.YT = {
                    loading: 0,
                    loaded: 0
                }), window.YTConfig || (window.YTConfig = {host: "http://www.youtube.com"}), YT.loading || (YT.loading = 1, function () {
                    var l = [];
                    YT.ready = function (f) {
    ...
    exports.__esModule = !0;
    var _Target2 = __webpack_require__(23), _Target3 = function (obj) {
        return obj && obj.__esModule ? obj : {default: obj}
    ...
    exports.__esModule = !0;
    var _Target2 = __webpack_require__(23), _Target3 = _interopRequireDefault(_Target2),
